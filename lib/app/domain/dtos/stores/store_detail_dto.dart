...
class StoreDetailDto {
  ...
  @override
  String toString() {
    return 'StoreDetailDto(id: $id, userId: $userId, name: $name, description: $description, image: $image, schedules: $schedules, pixKey: $pixKey, isDelivered: $isDelivered, deliveryTimeKm: $deliveryTimeKm, dynamicFreightKm: $dynamicFreightKm, isOpen: $isOpen, active: $active)';
  }
}
